...
l_cm = st.sidebar.slider("Longueur du pendule (L) [cm]", min_value=0.0, max_value=100.0, value=20.0, step=1.0)
theta_deg = st.sidebar.slider("Angle initial [degrés]", min_value=0, max_value=180, value=30)
